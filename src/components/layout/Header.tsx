    ...
    <header className="bg-white/95 backdrop-blur-md px-4 py-3 md:px-6 md:py-4 border-b border-gray-100 sticky top-0 z-30" aria-label="Cabeçalho da aplicação Wamíni">
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          <Link href="/dashboard" className="text-2xl font-black logo-wamini logo-dark text-gray-900 tracking-tight" style={{ color: '#111827' }} aria-label="Wamini: Painel Principal">
            Wamini
          </Link>
